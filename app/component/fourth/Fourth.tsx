    ...
    <div className="flex flex-wrap bg-gray-50 p-8 rounded-lg">
      ...
      <div className="flex-1 px-8">
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-2">
          <li>Custom furniture designs for modern interiors</li>
          <li>Natural elements to create warmth and elegance</li>
          <li>Optimized layouts for functionality and style</li>
          <li>Personalized consultations to meet your taste</li>
        </ul>
