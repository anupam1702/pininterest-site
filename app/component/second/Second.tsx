...
const Second = () => {
  return (
    <div className="bg-gray-100 flex flex-col md:flex-row items-center mt-8 p-8">
      {/* Text Section */}
      <div className="md:w-1/4 mb-8 md:mb-0">
        <h1 className="text-6xl font-bold mb-4">Crafted with <br /> excellent material.</h1>
      ...
      {/* Product Section */}
      <div className="md:w-1/2 flex flex-wrap md:flex-nowrap justify-center gap-6 md:gap-12">
        {/* Nordic Chair */}
        <div className="text-center w-full md:w-1/3 ml-18">
          <Image
